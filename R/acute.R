...
#'
#' @description A dataset of 65 trials comparing 14 treatments for acute mania treatment. The dataset contains response and dropout rate information, both of which are binary outcomes, along with treatments information.
#'
