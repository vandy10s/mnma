...
#' @description The function conducts univariate NMA using a \code{mnma.model} object as an input
...
#' names(res$outcome1)
#' res$outcome1$summary   # provides mean, standard deviation, and percentile information about log odds ratio
